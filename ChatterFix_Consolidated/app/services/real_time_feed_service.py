...
class RealTimeFeedService:
    ...
    async def notify_work_order_update(self, work_order_id: int, assigned_to: int = None):
        ...
        if assigned_to:
            ...
            await websocket_manager.send_personal_message(json.dumps(message), assigned_to)
