...
from ai_team.deployment_team import get_deployment_orchestrator, DeploymentConfig
...
async def test_deployment_team():
    ...
    print(f"\n🎯 **Deployment Plan:**")
    print(result.final_answer[:800] + "..." if len(result.final_answer) > 800 else result.final_answer)
...
async def main():
    ...
    try:
        ...
        print("\n📋 **Summary:**")
        print(f"  • General AI Team: {len(general_result.agent_responses)} agents collaborated")
