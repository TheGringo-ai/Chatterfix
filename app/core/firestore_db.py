...
class FirestoreManager:
    ...
    async def get_collection(self, collection: str, limit: int = None, order_by: str = None, filters: List[Dict] = None) -> List[Dict[str, Any]]:
    ...
    async def get_work_orders(self, status: str = None, assigned_to: str = None) -> List[Dict[str, Any]]:
        ...
        if assigned_to:
            filters.append({'field': 'assigned_to', 'operator': '==', 'value': assigned_to})
        
        return await self.get_collection('work_orders', order_by='-created_at', filters=filters)
    ...
    async def get_user_by_email(self, email: str) -> Optional[Dict[str, Any]]:
        """Get user by email"""
        users = await self.get_collection('users', filters=[{'field': 'email', 'operator': '==', 'value': email}])
    ...
    async def get_dashboard_data(self, user_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            ai_interactions = await self.get_collection('ai_interactions', limit=5, order_by='-timestamp')
