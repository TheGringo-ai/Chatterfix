...
async def validate_sensor_count(customer_id: str, sensor_count: int) -> Dict:
    ...
    if sensor_limit == 0:
        ...
        return {"valid": True, "message": "Unlimited sensors available"}
...
logger.info(
    "IoT Advanced Licensing initialized (using unified premium licensing system)"
)
