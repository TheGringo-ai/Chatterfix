...
class ModuleActivationRequest(BaseModel):
    ...
    module: str = Field(..., description="Module ID: iot_advanced, quality_fix, safety_fix, enterprise")
    ...
    modules = [
        {
            ...
            "supported_protocols": ["Modbus TCP/RTU", "MQTT", "HTTP API", "OPC-UA", "Serial"],
        ...
        },
        {
            ...
            "certifications_supported": ["SQF", "FSMA", "ISO 22000", "FSSC 22000", "BRC", "IFS"],
