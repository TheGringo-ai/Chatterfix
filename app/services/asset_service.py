...
class AssetService:
    ...
    async def get_assets(self, limit: int = 50) -> List[Asset]:
        assets_data = await self.firestore_manager.get_collection("assets", limit=limit, order_by="name")
    ...
    async def update_asset(self, asset_id: str, asset_data: Dict[str, Any]) -> bool:
        ...
        return await self.firestore_manager.update_document("assets", asset_id, asset_data)
