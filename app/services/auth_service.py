...
def create_user(username: str, email: str, password: str, full_name: str = None, role: str = "technician") -> Optional[int]:
    """
    Create a new user
...
def check_permission(user_role: str, required_permission: str) -> bool:
    ...
    role_permissions = {
        "manager": ["all"],
        "supervisor": ["view_all_work_orders", "approve_work_orders", "manage_team", "view_reports"],
        "planner": ["schedule_work_orders", "assign_technicians", "view_resources", "view_reports"],
        "parts_manager": ["manage_inventory", "manage_vendors", "approve_parts_requests", "view_inventory_reports"],
        "technician": ["complete_work_orders", "use_parts", "view_assigned_work_orders", "update_status"],
