...
async def recognize_part(image_data: bytes = None, image_path: str = None) -> Dict[str, Any]:
    """
...
async def analyze_asset_condition(image_data: bytes = None, image_path: str = None, asset_id: int = None) -> Dict[str, Any]:
    """
