...
class DashboardService:
    ...
    def get_widget_data(self, widget_type: str, user_id: int, config: Optional[Dict] = None) -> Dict[str, Any]:
    ...
    def get_performance_data(self, user_id: int, config: Dict) -> Dict[str, Any]:
        ...
        return {
            "today": {
                ...
                "avg_hours": round(today_stats['avg_hours'], 1) if today_stats and today_stats['avg_hours'] else 0
            },
            "this_week": {
                "completed": week_stats['completed'] if week_stats else 0,
                "avg_hours": round(week_stats['avg_hours'], 1) if week_stats and week_stats['avg_hours'] else 0
            },
    ...
    def get_quick_actions_data(self, user_id: int, config: Dict) -> Dict[str, Any]:
        ...
        return {
            "actions": [
                {"id": "report_emergency", "label": "Report Emergency", "icon": "🚨", "color": "danger"},
                {"id": "request_parts", "label": "Request Parts", "icon": "📦", "color": "primary"},
                {"id": "clock_in", "label": "Clock In/Out", "icon": "🕐", "color": "info"},
                {"id": "start_break", "label": "Start Break", "icon": "☕", "color": "warning"},
                {"id": "ar_mode", "label": "AR Mode", "icon": "🥽", "color": "success"},
                {"id": "submit_feedback", "label": "Submit Feedback", "icon": "💬", "color": "secondary"}
            ]
        }
    ...
    def get_ai_insights_data(self, user_id: int, config: Dict) -> Dict[str, Any]:
        ...
        return {
            "insights": [
                {"type": "prediction", "message": "Pump #5 may fail within 7 days", "confidence": 0.85, "priority": "high"},
                {"type": "recommendation", "message": "Schedule PM for HVAC Unit 3 this week", "confidence": 0.92, "priority": "medium"}
            ]
        }
