...
class PushNotificationService:
    ...
    async def send_notification(
        ...
        try:
            conn.execute(
                ...
                VALUES (?, ?, ?, ?, ?, ?)
            """,
                (user_id, "push", title, body, url, priority),
            )
            conn.commit()
    ...
    async def send_urgent_work_order_notification(
        ...
        return await self.send_notification(
            ...
            data={"type": "work_order", "work_order_id": work_order_id},
        )
    ...
    async def send_pm_due_notification(
        self, user_id: int, asset_id: int, asset_name: str, due_date: str
    ) -> Dict[str, Any]:
        ...
        return await self.send_notification(
            ...
            priority="normal",
            tag=f"pm-{asset_id}",
            data={"type": "pm_due", "asset_id": asset_id},
        )
        ...
        try:
            ...
            for user_id in users:
                result = await self.send_notification(
                    user_id=user_id, title=title, body=body, url=url, priority=priority
                )
