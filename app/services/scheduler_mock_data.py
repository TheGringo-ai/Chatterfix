...
from app.services.advanced_scheduler_service import (
    TechnicianProfile, Skill, WorkShift, AssetRequirement, 
    TechnicianStatus, ScheduleType, Priority
)
...
class SchedulerMockDataService:
    ...
    def __init__(self):
        ...
        self.shifts = [
            ...
            WorkShift(time(14, 0), time(22, 0), "UTC", [0, 1, 2, 3, 4]),  # Evening shift  
    ...
    def generate_technician_profiles(self, count: int = 25) -> Dict[str, TechnicianProfile]:
        ...
        names = [
            ...
            ("Robert", "Davis"), ("Angela", "Thompson"), ("James", "Garcia"), ("Maria", "Gonzalez"),
            ("Kevin", "Lee"), ("Rachel", "White"), ("Daniel", "Martinez"), ("Ashley", "Johnson"),
            ("Brandon", "Smith"), ("Stephanie", "Jones"), ("Tyler", "Williams"), ("Nicole", "Anderson"),
            ("Christopher", "Taylor"), ("Amanda", "Clark"), ("Justin", "Lewis"), ("Samantha", "Hall"),
            ("Anthony", "Young"), ("Rebecca", "Walker"), ("Michael", "Allen"), ("Laura", "King"),
            ("Ryan", "Wright"), ("Melissa", "Scott"), ("Jason", "Green"), ("Kimberly", "Adams"),
            ("Matthew", "Baker"), ("Elizabeth", "Nelson"), ("Andrew", "Carter"), ("Michelle", "Mitchell")
        ]
        ...
        skill_combinations = [
            ...
            ["cnc_operation", "mechanical", "troubleshooting", "preventive_maintenance"],
            ...
            ["boiler_operation", "safety_inspection", "preventive_maintenance", "troubleshooting"]
        ]
        ...
        for i in range(min(count, len(names))):
            ...
            additional_skills = random.sample(
                [skill for skill in self.skill_definitions.keys() if skill not in base_skills], 
                random.randint(1, 3)
            )
            ...
            for skill_name in all_skills:
                if skill_name in self.skill_definitions:
                    ...
                    cert_expiry = None
                    if certified:
                        cert_expiry = datetime.now() + timedelta(days=random.randint(180, 730))
                    ...
                    total_skill_value += level * self.skill_definitions[skill_name]["complexity"]
            ...
            shift_index = random.choices(range(len(self.shifts)), weights=shift_weights)[0]
            ...
            technicians[tech_id] = TechnicianProfile(
                ...
                max_hours_per_day=8 if shift_index < 3 else 10,  # Extended shifts allow more hours
    ...
    def generate_asset_requirements(self, count: int = 50) -> Dict[str, AssetRequirement]:
        ...
        asset_types = [
            {
                ...
                "locations": ["Building A - Production Floor", "Building B - Assembly Line"]
            },
            {
                "prefix": "cnc_machine", 
                "count": 12,
                "skills": ["cnc_operation", "electrical", "mechanical", "troubleshooting"],
            ...
            },
            {
                ...
                "locations": ["Warehouse North", "Warehouse South", "Building B - Assembly Line"]
            },
            {
                "prefix": "motor_drive",
                "count": 15,
                ...
                "locations": ["Building A - Production Floor", "Building B - Assembly Line", "Building C - Quality Control"]
            },
            {
                "prefix": "hvac_unit",
                "count": 6,
            ...
            },
            {
                "prefix": "robotic_cell",
                "count": 6,
                "skills": ["robotics", "electrical", "plc_programming", "safety_inspection"],
            ...
            },
            {
                "prefix": "boiler_unit",
                "count": 3,
                "skills": ["boiler_operation", "safety_inspection", "preventive_maintenance"],
                "duration_range": (4.0, 8.0),
                "criticality_range": (4, 5),
            ...
            },
            {
                ...
                "criticality_range": (4, 5),
                "maintenance_interval": 30,
                "locations": ["Building A - Production Floor", "Building B - Assembly Line", "Warehouse North"]
            },
            {
                "prefix": "forklift",
                "count": 8,
    ...
    def generate_emergency_scenarios(self, count: int = 10) -> List[Dict[str, Any]]:
        ...
        emergency_types = [
            ...
            },
            {
                ...
                "required_skills": ["electrical", "safety_inspection", "troubleshooting"],
