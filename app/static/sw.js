// ChatterFix CMMS - Enhanced Service Worker for Full Offline Functionality
// Version 2.0 - Includes IndexedDB caching, background sync, and push notifications

const CACHE_VERSION = 'v2';
const CACHE_NAME = `chatterfix-${CACHE_VERSION}`;
const DATA_CACHE_NAME = `chatterfix-data-${CACHE_VERSION}`;
const DB_NAME = 'ChatterFixDB';
const DB_VERSION = 1;
