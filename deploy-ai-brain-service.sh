#!/bin/bash
# Deploy ChatterFix AI Brain Service to Google Cloud Run

echo "🤖 Deploying ChatterFix AI Brain Service..."

# Create cloud-compatible AI service (without local Ollama dependency)
cat > cloud_ai_service.py << 'EOF'
#!/usr/bin/env python3
"""
...
echo "✅ ChatterFix AI Brain Service deployed!"

# Test the deployment
SERVICE_URL=$(gcloud run services describe chatterfix-ai-brain --platform managed --region us-central1 --format 'value(status.url)')
...
echo ""
echo "🌟 ChatterFix AI Brain Service is now live!"
echo "🔗 URL: $SERVICE_URL"
echo ""
echo "Next steps:"
echo "1. Update ChatterFix website to use this AI service URL"
echo "2. Set OPENAI_API_KEY environment variable for full functionality"
echo "3. Test the chat functionality on https://chatterfix.com"