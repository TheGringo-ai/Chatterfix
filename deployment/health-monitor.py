...
class HealthMonitor:
    ...
    def run_health_check(self) -> bool:
        ...
        if all_passed:
            ...
            print(
                f"❌ Health check FAILED (consecutive failures: {self.consecutive_failures})"
            )
...
def main():
    ...
    parser.add_argument(
        "--interval", type=int, help="Check interval in seconds", default=CHECK_INTERVAL
    )
    parser.add_argument(
        "--threshold", type=int, help="Failure threshold", default=FAILURE_THRESHOLD
    )
