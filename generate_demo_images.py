...
def create_part_image(name, color, size=(200, 150)):
    ...
    draw.line([center_x-radius//2, center_y, center_x+radius//2, center_y], fill='white', width=2)
    draw.line([center_x, center_y-radius//2, center_x, center_y+radius//2], fill='white', width=2)
...
def generate_demo_images():
    ...
    # User avatar images
    avatar_colors = ['#FF5722', '#4CAF50', '#2196F3', '#FF9800', '#9C27B0', '#607D8B', '#E91E63']
    avatars = ['admin.jpg', 'sarah.jpg', 'mike.jpg', 'alex.jpg', 'jennifer.jpg', 'david.jpg', 'lisa.jpg']
