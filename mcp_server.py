...
from app.routers.demo import (
    DEMO_ASSETS, DEMO_WORK_ORDERS, DEMO_TEAM, DEMO_STATS
)
            ...
            inputSchema={
                ...
                "properties": {
                    "feature": {
                        ...
                        "enum": ["purchasing", "assets", "work_orders", "analytics", "all"]
                    }
                },
                "required": ["feature"]
            }
...
async def comprehensive_showcase_validation(include_performance: bool = False) -> Dict[str, Any]:
    ...
    features_to_check = [
        "asset_management", "work_orders", "purchasing", "analytics", 
        "team_management", "ar_mode", "training", "inventory"
    ]
    ...
    validation["feature_parity"]["purchasing"]["live_data"] = purchasing_validation.get("live_data_access", False)
