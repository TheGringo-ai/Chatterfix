...
REALISTIC_PARTS = [
    ...
    {
        "name": "V-Belt - Industrial",
        "part_number": "BLT-A68",
        "description": "A-section V-belt, 68 inch length",
        "unit_cost": 12.50,
        "category": "Belts",
    },
    {
        "name": "Hydraulic Filter Element",
        "part_number": "HYD-FLT-10M",
        "description": "10 micron hydraulic filter, 6x12 inch",
        "unit_cost": 45.00,
        "category": "Filters",
    },
    {
        ...
        "description": "40A 3-pole contactor, 120V coil",
        "unit_cost": 78.50,
        "category": "Electrical",
    },
    {
        "name": "Fuse - Industrial",
        "part_number": "FUSE-30A-600V",
        "description": "30A 600V time-delay fuse",
        "unit_cost": 8.25,
        "category": "Electrical",
    },
    {
        "name": "Pneumatic Cylinder Seal Kit",
        "part_number": "CYL-SK-2IN",
        "description": "Seal kit for 2-inch bore pneumatic cylinder",
        "unit_cost": 35.00,
        "category": "Pneumatics",
    },
    {
        "name": "Motor - 5HP 3-Phase",
        "part_number": "MTR-5HP-1800",
        "description": "5HP 1800RPM 3-phase motor, TEFC",
        "unit_cost": 485.00,
        "category": "Motors",
    },
    {
        ...
        "description": "1.5 inch flexible jaw coupling",
        "unit_cost": 95.25,
        "category": "Power Transmission",
    },
    {
        "name": "Oil - Hydraulic AW46",
        "part_number": "OIL-HYD-AW46",
        "description": "5 gallon hydraulic oil AW46",
        "unit_cost": 65.00,
        "category": "Lubricants",
    },
    {
        "name": "Grease - Multi-Purpose",
        "part_number": "GRS-MP-14OZ",
        "description": "14oz cartridge multi-purpose grease",
        "unit_cost": 8.50,
        "category": "Lubricants",
    },
    {
        "name": "Air Filter - Compressor",
        "part_number": "AF-COMP-IR37",
        "description": "Replacement air filter for IR 37kW compressor",
        "unit_cost": 125.00,
        "category": "Filters",
    },
    {
        "name": "Limit Switch",
        "part_number": "LS-HD-SPDT",
        "description": "Heavy duty limit switch SPDT",
        "unit_cost": 42.00,
        "category": "Sensors",
    },
    {
        "name": "Proximity Sensor - Inductive",
        "part_number": "PROX-IND-8MM",
        "description": "8mm inductive proximity sensor, NPN",
        "unit_cost": 55.00,
        "category": "Sensors",
    },
    {
        "name": "Solenoid Valve - 24VDC",
        "part_number": "SOL-24V-1/4",
        "description": "1/4 inch 24VDC solenoid valve",
        "unit_cost": 68.00,
        "category": "Valves",
    },
    {
        "name": "Pressure Gauge",
        "part_number": "PG-0-100PSI",
        "description": "0-100 PSI pressure gauge, 2.5 inch dial",
        "unit_cost": 28.00,
    ...
    },
    {
        ...
        "description": "10 feet of #60 roller chain",
        "unit_cost": 45.75,
        "category": "Power Transmission",
    },
    {
        "name": "Sprocket - #60 24T",
        "part_number": "SPRKT-60-24",
        "description": "#60 chain sprocket, 24 teeth",
        "unit_cost": 32.50,
        "category": "Power Transmission",
    },
    {
        "name": "Pilot Light - LED Green",
        "part_number": "PLT-LED-GRN",
        "description": "22mm LED pilot light, green, 24V",
        "unit_cost": 12.75,
        "category": "Electrical",
    },
    {
        "name": "Push Button - Emergency Stop",
        "part_number": "PB-ESTOP-40",
        "description": "40mm mushroom head E-stop, NC",
        "unit_cost": 35.00,
        "category": "Electrical",
    },
    {
        "name": "Thermostat - Industrial",
        "part_number": "THERM-IND-F",
        "description": "Industrial thermostat, 40-110F range",
        "unit_cost": 85.00,
        "category": "HVAC",
    },
]
...
WORK_ORDER_TEMPLATES = [
    ...
    {
        "title": "PM - Monthly Lubrication",
        "type": "Preventive",
        "description": "Perform monthly lubrication on all grease points per PM schedule. Check oil levels and top off as needed.",
    },
    {
        "title": "PM - Quarterly Inspection",
        "type": "Preventive",
        "description": "Complete quarterly inspection checklist. Check belt tension, bearing condition, and general equipment condition.",
    },
    {
        "title": "PM - Annual Overhaul",
        "type": "Preventive",
        "description": "Annual preventive maintenance overhaul. Replace wear parts, clean thoroughly, and verify calibration.",
    },
    {
        "title": "PM - Filter Replacement",
        "type": "Preventive",
        "description": "Replace all air and oil filters per maintenance schedule. Document filter condition.",
    },
    {
        "title": "PM - Belt Inspection and Tensioning",
        "type": "Preventive",
        "description": "Inspect all drive belts for wear, cracks, and proper tension. Adjust or replace as needed.",
    },
    # Corrective Maintenance
    {
        "title": "Repair - Unusual Vibration",
        "type": "Corrective",
        "description": "Equipment exhibiting unusual vibration. Investigate root cause and repair. Check bearings and alignment.",
    },
    {
        "title": "Repair - Overheating Issue",
        "type": "Corrective",
        "description": "Equipment running hot. Check cooling system, clean heat exchangers, and verify proper airflow.",
    },
    {
        "title": "Repair - Hydraulic Leak",
        "type": "Corrective",
        "description": "Hydraulic oil leak detected. Locate source of leak, replace seals/fittings as needed.",
    },
    {
        "title": "Repair - Electrical Fault",
        "type": "Corrective",
        "description": "Intermittent electrical fault reported. Troubleshoot electrical system and repair.",
    },
    {
        "title": "Repair - Abnormal Noise",
        "type": "Corrective",
        "description": "Operator reported abnormal noise during operation. Investigate and correct.",
    },
    {
        "title": "Repair - Pressure Drop",
        "type": "Corrective",
        "description": "System pressure not reaching setpoint. Check for leaks, worn pump, or clogged filters.",
    },
    {
        "title": "Repair - Motor Not Starting",
        "type": "Corrective",
        "description": "Motor fails to start. Check electrical connections, overloads, and motor windings.",
    },
    # Emergency
    {
        "title": "Emergency - Equipment Down",
        "type": "Emergency",
        "description": "URGENT: Equipment completely down, halting production. Immediate response required.",
    },
    {
        "title": "Emergency - Safety Concern",
        "type": "Emergency",
        "description": "URGENT: Safety issue identified. Equipment locked out until repairs complete.",
    },
    # Inspection
    {
        "title": "Inspection - Safety Systems",
        "type": "Inspection",
        "description": "Inspect all safety systems including E-stops, guards, and interlocks. Document findings.",
    },
    {
        "title": "Inspection - Pre-Shift Check",
        "type": "Inspection",
        "description": "Complete pre-shift inspection checklist. Verify fluid levels, guards in place, and general condition.",
    },
]
...
async def populate_realistic_data():
    ...
    for asset_data in REALISTIC_ASSETS:
        full_asset = {
            **asset_data,
            ...
            "purchase_date": (
                datetime.now() - timedelta(days=random.randint(365, 2000))
            ).strftime("%Y-%m-%d"),
        ...
        try:
            ...
            created_assets.append(
                {"id": asset_id, "name": asset_data["name"], "type": asset_data["type"]}
            )
        ...
        full_part = {
            **part_data,
            ...
            "location": random.choice(
                ["Parts Room A", "Parts Room B", "Electrical Cabinet", "MRO Storage"]
            ),
        }
    ...
    for i in range(25):
        ...
        if status == "Completed":
            ...
            work_order_data["actual_hours"] = round(
                work_order_data["estimated_hours"] + random.uniform(-1, 2), 1
            )
            work_order_data["work_summary"] = (
                f"Completed {template['type'].lower()} maintenance. All issues addressed and equipment returned to service."
            )

        try:
            wo_id = await firestore_manager.create_document(
