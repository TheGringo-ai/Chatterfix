#!/usr/bin/env python3
"""
AI Review Module - Integrates with AI team for intelligent analysis.
"""
...
def get_ai_analysis(
    ...
    if not GEMINI_AVAILABLE:
        print("      [WARN] AI service not available, skipping")
        return None

    # Build context for AI
    context = _build_context(clone_path, stack_info, analysis_results)

    prompt = f"""You are a senior software engineer performing a maintenance review.

Analyze this repository context and provide actionable recommendations.
...
RECOMMENDATIONS:
1. [Most important fix] - [Why it matters]
...
Keep recommendations specific and actionable. Focus on security and reliability.
"""
